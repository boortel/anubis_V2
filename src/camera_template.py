...
class Camera_template:
    ...
    def start_recording(self,folder_path,name_scheme,fps,):
    ...
    def _frame_consumer(self, folder_path, name_scheme, fps = 0):
        ...
        @param[in] fps maximum frames per second to be saved.
        """
        if(folder_path[-1] != '/'):
